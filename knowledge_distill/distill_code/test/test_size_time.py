# coding=utf-8
"""test time & size for Pytorch model(BERT, TinyBERT & Bi-LSTM)
   step 1: set do_predict
...
class InputFeatures(object):
    ...
    def __init__(self, input_ids_lstm, input_ids_bert, input_mask, segment_ids, label_id, seq_length_lstm=None,
                 seq_length_bert=None):
...
def get_tensor_data(output_mode, features):
    ...
    tensor_data = TensorDataset(all_input_ids_lstm, all_input_ids_bert, all_input_mask, all_segment_ids, all_label_ids,
                                all_seq_lengths_lstm, all_seq_lengths_bert)
...
def do_eval(model, task_name, eval_dataloader, device, output_mode, eval_labels, num_labels):
    ...
    time_rec2 = time.time()
    print('time rec: {}ms'.format(((time_rec2 - time_rec1)*1000)))
...
def main():
    ...
    if not args.do_predict:
        ...
        train_features = convert_examples_to_features(train_examples, label_list, args.max_seq_len, bert_tokenizer,
                                                      output_mode)
        ...
        eval_features = convert_examples_to_features(eval_examples, label_list, args.max_seq_len, bert_tokenizer,
                                                     output_mode)
    ...
    if args.do_predict:
        ...
        test_features = convert_examples_to_features(test_examples, label_list, args.max_seq_len, bert_tokenizer,
                                                     output_mode)
